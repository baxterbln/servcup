        ...
        <ul class="nav-profile">
            <li class="profile dropdown">
                ...
                <div class="dropdown-menu profile-dropdown-menu" aria-labelledby="dropdownMenu1">
                    <a class="dropdown-item" href="#"> <i class="fa fa-user icon"></i> Rechnungen </a>
                    <a class="dropdown-item" href="#"> <i class="fa fa-bell icon"></i> Bestellungen </a>
                </div>
            </li>
            <!--<li class="profile dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu profile-dropdown-menu" aria-labelledby="dropdownMenu1">
                    <a class="dropdown-item" href="#"> <i class="fa fa-user icon"></i> Kunden </a>
                    <a class="dropdown-item" href="#"> <i class="fa fa-bell icon"></i> Produkte </a>
                </div>
            </li>-->
